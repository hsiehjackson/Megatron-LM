...
class TestGPTUnifiedModel:
    ...
    def setup_method(self, method):
        ...
        transformer_config = TransformerConfig(num_layers=2, 
                                               ...
                                               rotary_percent=1.0)
        general_config = ModelGeneralConfig(model_decoder_layer_spec=get_gpt_layer_with_transformer_engine_spec(), vocab_size=100, max_sequence_length=4)
        self.gpt_model = GPTModel(config=transformer_config, general_config=general_config)
